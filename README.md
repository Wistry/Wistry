...
<div align="left">
  <div style="display: flex; align-items: center; margin-bottom: 10px;">
    <img src="https://raw.githubusercontent.com/Wistry/MuseoValverde/main/imagenes/logotipo.png" alt="Logo MuseoValverde" width="80" style="margin-right: 10px;">
    <p><strong><a href="https://github.com/Wistry/MuseoValverde" target="_blank">MuseoValverde</a></strong>: Práctica de programación web para un museo, con gestión de obras (DB no incluida).</p>
  </div>

  <div style="display: flex; align-items: center; margin-bottom: 10px;">
    <img src="https://github.com/Wistry/EcolivingProductions/raw/8011dab2856556399ec474bb12a88e10533b0202/webapp/images/logo.png" alt="Logo EcolivingProductions" width="80" style="margin-right: 10px;">
    <p><strong><a href="https://github.com/Wistry/EcolivingProductions" target="_blank">EcolivingProductions</a></strong>: Proyecto colaborativo de una tienda online de muebles inteligentes ecológicos.</p>
  </div>

  <div style="display: flex; align-items: center; margin-bottom: 10px;">
    <img src="https://github.com/Wistry/AppComparadorVideojuegos/raw/main/src/main/resources/static/LOGO.jpeg" alt="Logo PricePlayPay" width="80" style="margin-right: 10px;">
    <p><strong><a href="https://github.com/Wistry/AppComparadorVideojuegos" target="_blank">AppComparadorVideojuegos</a></strong>: Aplicación para comparar precios de videojuegos usando API y web scraping.</p>
  </div>
